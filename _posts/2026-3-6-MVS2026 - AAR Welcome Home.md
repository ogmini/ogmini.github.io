...
Interestingly, the iLEAPP plugin from Kevin Pagano reports the Redirect Source and Redirect Direction from the database while Magnet Axiom doesn't show this or at least not by default. I'd like to get confirmation; but it looks like the individual was hosting something on their device since we see 127.0.0.1 (loopback address) that utilized Google OAuth 2.0 authorization. I'm intrigued to know what they were hosting...
